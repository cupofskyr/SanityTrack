            ...
            <Card>
                <CardHeader className="flex-row items-start justify-between">
                    <div>
                        ...
                        <CardDescription>
                            This is the master control panel for the AI agent. Enable, disable, and create custom rules here. These are the default rules for all new locations.
                        </CardDescription>
                    </div>
                ...
                <CardContent className="space-y-6">
                    <div className="flex items-center space-x-4 rounded-lg border p-4">
                     ...
                     <Alert variant="destructive">
                        ...
                        <AlertDescription>
                            Enabling the Sentinel Agent allows the AI to take actions on your behalf, such as creating tasks or sending notifications. Review all actions in the Agent Activity Log on the owner dashboard.
                        </AlertDescription>
                    </Alert>
                </CardContent>
            </Card>
