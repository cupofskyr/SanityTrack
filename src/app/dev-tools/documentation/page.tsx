    ...
    return (
        <Card>
            <CardHeader>
                ...
                <CardDescription>
                    This is the master guide for the Leifur AI application, its features, and the underlying AI engine.
                </CardDescription>
            </CardHeader>
            <CardContent>
                <div className="prose prose-sm dark:prose-invert max-w-none p-4 border rounded-md bg-muted/50 max-h-[70vh] overflow-y-auto">
